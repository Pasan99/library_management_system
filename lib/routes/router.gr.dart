...
class NewRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    RegistrationPageRoute.name: (entry) {
      return _i1.MaterialPageX(entry: entry, child: _i5.RegistrationPage());
    }
  };
  ...
  List<_i1.RouteConfig> get routes => [
        ...
        _i1.RouteConfig(RegistrationPageRoute.name, path: '/register')
      ];
}
...
class RegistrationPageRoute extends _i1.PageRouteInfo {
  const RegistrationPageRoute() : super(name, path: '/register');
